...
const AdminReports = () => {
				...
				<div className="flex justify-between items-center">
					<div>
						<h1 className="text-2xl font-bold text-gray-900 flex items-center">
							<BarChart3 className="w-7 h-7 text-indigo-600 mr-2" />
							Reports & Analytics
						</h1>
	...
	return (
		<div className="space-y-6">
							...
							{reportData.topProducts.slice(0, 5).map((product, index) => (
								<div key={product.id} className="flex items-center space-x-4">
									<div className="flex-shrink-0">
										<span className="flex items-center justify-center w-8 h-8 bg-indigo-100 text-indigo-600 text-sm font-medium rounded-full">
											{index + 1}
										</span>
									</div>
			...
			{/* Performance Summary */}
			<div className="bg-gradient-to-r from-indigo-50 to-red-50 p-6 rounded-lg border border-indigo-200">
